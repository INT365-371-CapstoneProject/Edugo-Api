...
type AnnouncePostCreateRequest struct {
	...
	Description  string     `json:"description" validate:"required,min=10,max=3000" message:"Description is required and must be between 10-500 characters"`
	...
	Posts_Type   string     `json:"posts_type" validate:"required,oneof=Announce" message:"Posts_Type is required and must be 'Announce'"`
...
type PostCreateRequest struct {
	...
	Description  string     `json:"description" validate:"required,min=10,max=3000" message:"Description is required and must be between 10-500 characters"`
	Image        *string    `json:"image"`
	Posts_Type   string     `json:"posts_type" validate:"required,oneof=Subject" message:"Posts_Type is required and must be 'Subject'"`
	Publish_Date *time.Time `json:"publish_date"`
	Country_ID   uint       `json:"country_id" validate:"required" message:"Country_ID is required"`
}
...
type PostUpdateRequest struct {
	...
	Description  string     `json:"description" validate:"omitempty,min=10,max=3000" message:"Description is must be between 10-500 characters"`
	Image        *string    `json:"image"`
	Publish_Date *time.Time `json:"publish_date"`
